...
<head>
    ...
    <!-- Favicon icon-->
    <link rel="shortcut icon" type="image/png" href="<?= base_url(); ?>cms/images/logos/favicon.png" />
    ...
    <!-- Owl Carousel  -->
    <link rel="stylesheet" href="<?= base_url(); ?>cms/libs/owl.carousel/dist/assets/owl.carousel.min.css" />
    <link rel="stylesheet" href="<?= base_url(); ?>cms/libs/aos/dist/aos.css" />
</head>
...
<body>
    ...
    <!-- Preloader -->
    <div class="preloader">
        <img src="<?= base_url(); ?>cms/images/logos/favicon.png" alt="loader" class="lds-ripple img-fluid" />
    </div>
    <div id="main-wrapper flex-column">
            ...
            <nav class="navbar navbar-expand-lg py-0">
                <div class="container">
                    <a class="navbar-brand me-0 py-0" href="index.html">
                        <img src="<?= base_url(); ?>cms/images/logos/dark-logo.svg" alt="img-fluid" />
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav align-items-center mb-2 mb-lg-0 ms-auto">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="<?= base_url(); ?>cms/images/demos/demo-main.jpg" alt="modernize-img" class="img-fluid" />
                                                        <a target="_blank" href="../main/index.html" class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                                            Preview</a>
                                                    </div>
                                                ...
                                                <div class="col">
                                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="<?= base_url(); ?>cms/images/demos/demo-dark.jpg" alt="modernize-img" class="img-fluid" />
                                                        <a target="_blank" href="../dark/index2.html" class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                                            Preview</a>
                                                    </div>
                                                    <h6 class="mb-0 text-center fw-bolder fs-3">
                                                        Dark
                                                ...
                                                <div class="col">
                                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="<?= base_url(); ?>cms/images/demos/demo-horizontal.jpg" alt="modernize-img" class="img-fluid" />
                                                        <a target="_blank" href="../horizontal/index3.html" class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                                            Preview</a>
                                                    </div>
                                                    <h6 class="mb-0 text-center fw-bolder fs-3">
                                                        Horizontal
                                                ...
                                                <div class="col">
                                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="<?= base_url(); ?>cms/images/demos/demo-minisidebar.jpg" alt="modernize-img" class="img-fluid" />
                                                        <a target="_blank" href="../minisidebar/index4.html" class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                                            Preview</a>
                                                    </div>
                                                    <h6 class="mb-0 text-center fw-bolder fs-3">
                                                        Minisidebar
                                                ...
                                                <div class="col">
                                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="<?= base_url(); ?>cms/images/demos/demo-rtl.jpg" alt="modernize-img" class="img-fluid" />
                                                        <a target="_blank" href="../rtl/index5.html" class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                                            Preview</a>
                                                    </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-12">
                                            <div class="row justify-content-between">
                                                <div class="col">
                                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="<?= base_url(); ?>cms/images/apps/app-calendar.jpg" alt="modernize-img" class="img-fluid" />
                                                        <a target="_blank" href="../main/app-calendar.html" class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                                            Preview</a>
                                                    </div>
                                                    <h6 class="mb-0 text-center fw-bolder fs-3">
                                                        Calendar
                                                ...
                                                <div class="col">
                                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="<?= base_url(); ?>cms/images/apps/app-chat.jpg" alt="modernize-img" class="img-fluid" />
                                                        <a target="_blank" href="../main/app-chat.html" class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                                            Preview</a>
                                                    </div>
                                                    <h6 class="mb-0 text-center fw-bolder fs-3">
                                                        Chat
                                                ...
                                                <div class="col">
                                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="<?= base_url(); ?>cms/images/apps/app-email.jpg" alt="modernize-img" class="img-fluid" />
                                                        <a target="_blank" href="../main/app-email.html" class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                                            Preview</a>
                                                    </div>
                                                    <h6 class="mb-0 text-center fw-bolder fs-3">
                                                        Email
                                                ...
                                                <div class="col">
                                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="<?= base_url(); ?>cms/images/apps/app-contact.jpg" alt="modernize-img" class="img-fluid" />
                                                        <a target="_blank" href="../main/app-contact2.html" class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                                            Preview</a>
                                                    </div>
                                                    <h6 class="mb-0 text-center fw-bolder fs-3">
                                                        Contact
                                                ...
                                                <div class="col">
                                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="<?= base_url(); ?>cms/images/apps/app-invoice.jpg" alt="modernize-img" class="img-fluid" />
                                                        <a target="_blank" href="../main/app-invoice.html" class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                                            Preview</a>
                                                    </div>
                                                    <h6 class="mb-0 text-center fw-bolder fs-3">
                                                        Invoice
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="position-relative">
                                                                <a target="_blank" href="../main/app-chat.html" class="d-flex align-items-center pb-9 position-relative lh-base">
                                                                    <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                                        <img src="<?= base_url(); ?>cms/images/svgs/icon-dd-chat.svg" alt="modernize-img" class="img-fluid" width="24" height="24" />
                                                                    </div>
                                                                    <div>
                                                                ...
                                                                <a target="_blank" href="../main/app-invoice.html" class="d-flex align-items-center pb-9 position-relative lh-base">
                                                                    <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                                        <img src="<?= base_url(); ?>cms/images/svgs/icon-dd-invoice.svg" alt="modernize-img" class="img-fluid" width="24" height="24" />
                                                                    </div>
                                                                    <div>
                                                                        <h6 class="mb-1 fw-semibold text-hover-primary">
                                                                            Invoice App
                                                                ...
                                                                <a target="_blank" href="../main/app-contact2.html" class="d-flex align-items-center pb-9 position-relative lh-base">
                                                                    <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                                        <img src="<?= base_url(); ?>cms/images/svgs/icon-dd-mobile.svg" alt="modernize-img" class="img-fluid" width="24" height="24" />
                                                                    </div>
                                                                    <div>
                                                                        <h6 class="mb-1 fw-semibold text-hover-primary">
                                                                            Contact Application
                                                                ...
                                                                <a target="_blank" href="../main/app-email.html" class="d-flex align-items-center pb-9 position-relative lh-base">
                                                                    <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                                        <img src="<?= base_url(); ?>cms/images/svgs/icon-dd-message-box.svg" alt="modernize-img" class="img-fluid" width="24" height="24" />
                                                                    </div>
                                                                    <div>
                                                                        <h6 class="mb-1 fw-semibold text-hover-primary">
                                                                            Email App
                                                        ...
                                                        <div class="col-6">
                                                            <div class="position-relative">
                                                                <a target="_blank" href="../main/page-user-profile.html" class="d-flex align-items-center pb-9 position-relative lh-base">
                                                                    <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                                        <img src="<?= base_url(); ?>cms/images/svgs/icon-dd-cart.svg" alt="modernize-img" class="img-fluid" width="24" height="24" />
                                                                    </div>
                                                                    <div>
                                                                        <h6 class="mb-1 fw-semibold text-hover-primary">
                                                                            User Profile
                                                                ...
                                                                <a target="_blank" href="../main/app-calendar.html" class="d-flex align-items-center pb-9 position-relative lh-base">
                                                                    <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                                        <img src="<?= base_url(); ?>cms/images/svgs/icon-dd-date.svg" alt="modernize-img" class="img-fluid" width="24" height="24" />
                                                                    </div>
                                                                    <div>
                                                                        <h6 class="mb-1 fw-semibold text-hover-primary">
                                                                            Calendar App
                                                                ...
                                                                <a target="_blank" href="../main/app-contact.html" class="d-flex align-items-center pb-9 position-relative lh-base">
                                                                    <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                                        <img src="<?= base_url(); ?>cms/images/svgs/icon-dd-lifebuoy.svg" alt="modernize-img" class="img-fluid" width="24" height="24" />
                                                                    </div>
                                                                    <div>
                                                                        <h6 class="mb-1 fw-semibold text-hover-primary">
                                                                            Contact List Table
                                                                ...
                                                                <a target="_blank" href="../main/app-notes.html" class="d-flex align-items-center pb-9 position-relative lh-base">
                                                                    <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                                        <img src="<?= base_url(); ?>cms/images/svgs/icon-dd-application.svg" alt="modernize-img" class="img-fluid" width="24" height="24" />
                                                                    </div>
                                                                    <div>
                                                                        <h6 class="mb-1 fw-semibold text-hover-primary">
                                                                            Notes Application
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative p-4 border-start h-100">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary" target="_blank" href="../main/page-pricing.html">Pricing Page</a>
                                                    </li>
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary" target="_blank" href="../main/authentication-login.html">Authentication Design</a>
                                                    </li>
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary" target="_blank" href="../main/authentication-register.html">Register Now</a>
                                                    </li>
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary" target="_blank" href="../main/authentication-error.html">404 Error Page</a>
                                                    </li>
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary" target="_blank" href="../main/app-notes.html">Notes App</a>
                                                    </li>
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary" target="_blank" href="../main/page-user-profile.html">User Application</a>
                                                    </li>
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary" target="_blank" href="../main/page-account-settings.html">Account Settings</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="../docs/index.html" target="_blank">Documentation</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="https://adminmart.com/support/" target="_blank">Support</a>
                            </li>
                            <li class="nav-item ms-2">
                                <a class="btn btn-primary fs-3 rounded btn-hover-shadow px-3 py-2" href="signin">Login</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col-xl-6">
                            <div class="hero-content my-5 my-xl-0">
                                ...
                                <div class="d-sm-flex align-items-center gap-3" data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000">
                                    <a class="btn btn-primary px-5 py-6 btn-hover-shadow d-block mb-3 mb-sm-0" href="signin">Login</a>
                                ...
                                <div class="d-flex flex-row">
                                    <div class="">
                                        <div class="banner-img-1 slideup">
                                            <img src="<?= base_url(); ?>cms/images/hero-img/bannerimg1.svg" alt="modernize-img" class="img-fluid" />
                                        </div>
                                        <div class="banner-img-1 slideup">
                                            <img src="<?= base_url(); ?>cms/images/hero-img/bannerimg1.svg" alt="modernize-img" class="img-fluid" />
                                        </div>
                                    ...
                                    <div class="">
                                        <div class="banner-img-2 slideDown">
                                            <img src="<?= base_url(); ?>cms/images/hero-img/bannerimg2.svg" alt="modernize-img" class="img-fluid" />
                                        </div>
                                        <div class="banner-img-2 slideDown">
                                            <img src="<?= base_url(); ?>cms/images/hero-img/bannerimg2.svg" alt="modernize-img" class="img-fluid" />
                                        </div>
                                ...
                                <ul class="list-unstyled d-flex align-items-center justify-content-center justify-content-sm-start mb-2 mb-sm-0">
                                    <li class="">
                                        <a class="d-block" href="javascript:void(0)">
                                            <img src="<?= base_url(); ?>cms/images/profile/user-1.jpg" alt="modernize-img" class="img-fluid border border-2 rounded-circle border-white" width="32" height="32" />
                                        </a>
                                    </li>
                                    <li class="ms-n2">
                                        <a class="d-block" href="javascript:void(0)">
                                            <img src="<?= base_url(); ?>cms/images/profile/user-2.jpg" alt="modernize-img" class="img-fluid border border-2 rounded-circle border-white" width="32" height="32" />
                                        </a>
                                    </li>
                                    <li class="ms-n2">
                                        <a class="d-block" href="javascript:void(0)">
                                            <img src="<?= base_url(); ?>cms/images/profile/user-3.jpg" alt="modernize-img" class="img-fluid border border-2 rounded-circle border-white" width="32" height="32" />
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="demos-view mt-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/app-calendar.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/app-calendar.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/app-chat.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/app-chat.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/app-email.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/app-email.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/app-contact.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/app-contact2.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/app-invoice.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/app-invoice.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/modernize-bt-app-contact-list.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/app-contact.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/app-user-profile.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/page-user-profile.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/modernize-vue-app-blog.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/blog-posts.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/modernize-vue-app-blog-detail.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/blog-detail.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/modernize-vue-app-shop.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/eco-shop.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/app-ecommerce-detail.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/eco-shop-detail.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="<?= base_url(); ?>cms/images/apps/app-ecommerce-list.jpg" alt="modernize-img" class="img-fluid" />
                                        <a target="_blank" href="../main/eco-product-list.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                    </div>
                ...
                <div class="py-md-5">
                    ...
                    <div class="sliding-wrapper position-relative overflow-hidden">
                        <div class="slide-background d-flex flex-row w-100">
                            <div class="slide">
                                <img src="<?= base_url(); ?>cms/images/slider/slider-group.png" alt="slide" height="100%" />
                            </div>
                            <div class="slide">
                                <img src="<?= base_url(); ?>cms/images/slider/slider-group.png" alt="slide" height="100%" />
                            </div>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="<?= base_url(); ?>cms/images/profile/user-1.jpg" alt="modernize-img" class="w-auto me-3 rounded-circle" width="40" height="40" />
                                                <div>
                                            ...
                                            <div>
                                                <ul class="list-unstyled d-flex align-items-center justify-content-end gap-1 mb-0">
                                                    <li>
                                                        <a href="">
                                                            <img src="<?= base_url(); ?>cms/images/svgs/icon-star.svg" alt="modernize-img" class="img-fluid" />
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="">
                            ...
                            <div class="item">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="<?= base_url(); ?>cms/images/profile/user-2.jpg" alt="modernize-img" class="w-auto me-3 rounded-circle" width="40" height="40" />
                                                <div>
                            ...
                            <div class="item">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="<?= base_url(); ?>cms/images/profile/user-3.jpg" alt="modernize-img" class="w-auto me-3 rounded-circle" width="40" height="40" />
                                                <div>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-7 col-xl-5 pt-lg-5 mb-5 mb-lg-0">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start gap-3">
                                <a href="signin" class="btn bg-white text-primary fw-semibold d-block mb-3 mb-sm-0 btn-hover-shadow px-7 py-6">Login</a>
                                <a href="../main/authentication-register.html" class="btn border-white text-white fw-semibold btn-hover-white d-block px-7 py-6">Register</a>
                            </div>
                        </div>
                        <div class="col-lg-5 col-xl-5">
                            <div class="text-center text-lg-end">
                                <img src="<?= base_url(); ?>cms/images/backgrounds/business-woman-checking-her-mail.png" alt="modernize-img" class="img-fluid" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="text-center">
                            <a href="index-new.html">
                                <img src="<?= base_url(); ?>cms/images/logos/favicon.ico" alt="modernize-img" class="img-fluid pb-3" />
                            </a>
                            <p class="mb-0 text-dark">
        ...
        <div class="offcanvas offcanvas-start modernize-lp-offcanvas" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div class="offcanvas-header p-4">
                <img src="<?= base_url(); ?>cms/images/logos/dark-logo.svg" alt="modernize-img" class="img-fluid" width="150" />
            </div>
            <div class="offcanvas-body p-4">
                <ul class="navbar-nav justify-content-end flex-grow-1">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu ps-2">
                            <li>
                                <a class="dropdown-item text-dark" href="./index.html">Dark</a>
                            </li>
                            <li>
                                <a class="dropdown-item text-dark" href="./index.html">Horizontal</a>
                            </li>
                            <li>
                                <a class="dropdown-item text-dark" href="./index.html">LTR</a>
                            </li>
                            <li>
                                <a class="dropdown-item text-dark" href="./index.html">Minisidebar</a>
                            </li>
                            <li>
                ...
                <form class="d-flex mt-3" role="search">
                    <a href="signin" class="btn btn-primary w-100 py-2">Login</a>
                </form>
            </div>
        </div>
    </div>
    ...
    <script src="<?= base_url(); ?>cms/libs/owl.carousel/dist/owl.carousel.min.js"></script>
    <script src="<?= base_url(); ?>cms/libs/aos/dist/aos.js"></script>
    <script src="<?= base_url(); ?>cms/js/landingpage/landingpage.js"></script>
</body>
